...
public class About extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        renfbIv = (ImageView) findViewById(R.id.renfbIv);
        renytIv = (ImageView) findViewById(R.id.renytIv);
        aboutIv = (ImageView) findViewById(R.id.aboutIv);
        aboutIv.setImageResource(R.drawable.about_logo);
        myfbIv.setOnClickListener(this);
        renfbIv.setOnClickListener(this);
        renytIv.setOnClickListener(this);
    ...
    */
    ...
    public void onClick(View v) {
        if (v == myfbIv) {
            ...
            String url = "http://m.facebook.com/jecrcrenaissance";
            Intent i = new Intent(Intent.ACTION_VIEW);
            i.setData(Uri.parse(url));
            startActivity(i);
        } else if (v == renytIv) {
            String url = "http://m.youtube.com/user/TheJECRCRenaissance";
            Intent i = new Intent(Intent.ACTION_VIEW);
            i.setData(Uri.parse(url));
            startActivity(i);
        }
